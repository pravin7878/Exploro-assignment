...
const AddLeadForm = () => {
  ...
  const { addedSuccess, Error } = useSelector(state => state.leads)
...
useEffect(()=>{
  if(addedSuccess){  toast.success("new lead data added success")}
  if(Error.isErr){ toast.error("error while adding lead , try again") } 
}, [addedSuccess,Error])
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => {
              ...
              // Allow only numeric input and restrict length to 10
